/* global $CC, Utils, $SD, haWebSocket, haWebSocket */
...
// const ha = new haWebSocket();
// ha.connect();

async function connected(jsn) {
  /** subscribe to the willAppear and other events */
  $SD.on("dev.timmo.homeassistant.action.willAppear", (jsonObj) =>
    action.onWillAppear(jsonObj)
  );
  $SD.on("dev.timmo.homeassistant.action.keyUp", (jsonObj) =>
    action.onKeyUp(jsonObj)
  );
  $SD.on("dev.timmo.homeassistant.action.sendToPlugin", (jsonObj) =>
    action.onSendToPlugin(jsonObj)
  );
  $SD.on("dev.timmo.homeassistant.action.didReceiveSettings", (jsonObj) =>
