...
Utils.haerveArray = function (object, callback) {
  "use strict";
  const array = [];
  const handler = {
    get(target, property, receiver) {
    ...
    set(target, property, value, receiver) {
      console.log("XXXUtils.haerveArray:set1:", target, property, value, array);
      target[property] = value;
      console.log("XXXUtils.haerveArray:set2:", target, property, value, array);
    },
    defineProperty(target, property, descriptor) {
      callback(target, property, descriptor);
      return Reflect.defineProperty(target, property, descriptor);
