    ...
    function (response) {
      ...
      file.on("finish", function () {
        file.close(function () {
          ...
          try {
            fs.removeSync(`./Release/dev.timmo.streamdeck-homeassistant`);
            let distributionCommand = `${currentPlatform.distributionToolFilename} -b -i ./build/dev.timmo.homeassistant.sdPlugin -o ./Release`;
            if (os.platform() !== "win32") {
